...
registerSet('penny-art', {
  binder: {
    ...
    subtitle: '45 slots · 7 illustrators · grouped by art',
    navTitle: 'Penny — By Artist · 45 slots',
  ...
  slots: [
    ...
    // ══ PAGE 2 · YUU CONCLUDED · OKACHEKE ══════════
    // yuu · the one-offs
    { id:'SV4a-182', name:'Penny', set:'Shiny Treasure ex', v:'r-jp', lang:'jp', sec:'p2',
      img:'https://limitlesstcg.nyc3.cdn.digitaloceanspaces.com/tpc/SV4a/SV4a_182_R_JP_SM.png',
      pc:'https://www.pricecharting.com/game/pokemon-japanese-shiny-treasure-ex/penny-182' },
    { id:'SVP-208CN', name:'Penny', set:'中文版 SV-P', v:'promo-cn', lang:'cn', sec:'p2',
      img:'cards/penny-cn/SVP-208CN.webp' },
    { id:'CSV1C-124MB', name:'Penny', set:'亘古开来', v:'mb-cn', lang:'cn', sec:'p2',
    ...
    { id:'PAF-239', name:'Penny', set:'Paldean Fates', v:'sir-en', lang:'en', sec:'p3',
    ...
    { id:'SFA-086', name:'Cassiopeia', set:'Shrouded Fable', v:'ur-en', lang:'en', sec:'p4',
